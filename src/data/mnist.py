...
class MNIST_DataLoader(DataLoader):
    ...
    def __init__(self):
        ...
        self.data_path = "/home/thinhbka/Desktop/oc-nn/data/mnist/"

        self.on_memory = True
        Cfg.store_on_gpu = True
        # print("Inside the MNIST_DataLoader RCAE.RESULT_PATH:", RCAE_AD.RESULT_PATH)
        self.rcae_results = "/home/thinhbka/Desktop/oc-nn/data/mnist/reports/figures/MNIST/RCAE/"
        self.modelsave_path = "/home/thinhbka/Desktop/oc-nn/data/mnist/models/MNIST/RCAE/"
